...
namespace status_strings {
    ...
    boost::asio::const_buffer to_buffer(StatusType newStatus) {
        switch (newStatus) {
            case StatusType::ok:
...
namespace stock_response {
    ...
    std::string to_string(StatusType currentStatus) {
...
Response Response::getStockResp(StatusType currentStatus) {
    Response resp;
    resp.status_ = currentStatus;
    resp.content = stock_response::to_string(currentStatus);
    ...
    resp.headers[2].name = "Server";
    resp.headers[2].value = "Boost::Asio FileServer";
    return resp;
}

void Response::setStatus(StatusType newStatus) {
    status_ = newStatus;
}
...
void Response::setHeaders(std::vector<header> newHeaders) {
    headers = newHeaders;
}
